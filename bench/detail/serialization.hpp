...
NLOHMANN_JSON_SERIALIZE_ENUM(InputProcessing,
                             {{InputProcessing::invalid, nullptr},
                              ...
                              {InputProcessing::eulertour_break_high_degree,
                               "eulertour-break-high-degree"},
                              {InputProcessing::none, "none"}})

NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(Config, kagen_option_string, input_processing);
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(InputDistributionStats,
                                   min_local_size,
                                   max_local_size,
                                   total_size);
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE(SparseRulingSetConfig,
                                   ...
                                   use_local_contraction,
                                   reverse_list_locality_aware,
                                   use_locality_aware_in_ruler_propagation,
                                   dehne_factor,
                                   heuristic_factor,
                                   sanders_factor,
                                   ultimate_factor,
                                   ultimate_sanders_factor,
                                   round_limit,
                                   cache_owners,
                                   root_gather_threshold,
                                   sync,
                                   sync_locality_aware,
                                   spawn,
