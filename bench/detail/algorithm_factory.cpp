...
auto get_algorithm(const Config& config,
  ...
  switch (config.algorithm) {
    ...
    case kascade::Algorithm::PointerDoubling:
      return std::make_unique<PointerDoubling>(config.pointer_doubling, comm, ranks_per_compute_node);
    ...
    case kascade::Algorithm::SparseRulingSet:
      return std::make_unique<SparseRulingSet>(config, comm, ranks_per_compute_node);
    case kascade::Algorithm::EulerTour:
      return std::make_unique<EulerTour>(config, comm, ranks_per_compute_node);
