...
auto lexical_cast(const std::string& input, RulerPropagationMode& ruler_propagation_mode)
    -> bool {
  nlohmann::json input_json = input;
...
auto parse_args(std::span<char*> args) -> Config {
  ...
  app.add_option("--sparse-ruling-set-ultimate-factor",
      ...
      ->group("Sparse Ruling Set");
  app.add_option("--sparse-ruling-set-ultimate-sanders-factor",
                 config.sparse_ruling_set.ultimate_sanders_factor)
      ->group("Sparse Ruling Set");
  ...
  app.add_flag("--sparse-ruling-set-post-invert", config.sparse_ruling_set.post_invert)
      ->group("Sparse Ruling Set");
  app.add_flag("--sparse-ruling-set-post-invert-detect-leaves",
               config.sparse_ruling_set.post_invert_detect_leaves)
      ->group("Sparse Ruling Set");
