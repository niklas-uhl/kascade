...
The directory `./legacy/` contains legacy implementations from Thomas Weidmann's thesis and has no license attached. Thomas Weidmann holds the copyright for these files. See https://github.com/ThomasWeidmann/MasterarbeitCode for the original repository.
